...
var stripe = Stripe('pk_test_51IIzBuDuifylZME6dKjpzDYo8IWmNcgMLEctu1cN6bn7r3pCtcsFa1H0oeDROQ6HE3BtUFEkpZMR8k1lLj1DPJrd00u2cF3UUi');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successfully reqistered!');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
